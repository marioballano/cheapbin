#ifndef CHEAPBIN_SDL_FONT8X8_H
#define CHEAPBIN_SDL_FONT8X8_H

#include <stdint.h>

/* Public-domain 8x8 bitmap font covering printable ASCII (0x20..0x7E)
   plus a handful of pseudo-graphic glyphs in the top half used by the
   ASCII-art port (block shades, vertical bar, frame corners, arrows).

   Each glyph is 8 bytes; bit 0 of each byte is the leftmost pixel. */

static const uint8_t FONT8X8[128][8] = {
    /* 0x00..0x1F : reserved / control. We only fill a few useful slots. */
    [0x00]={0,0,0,0,0,0,0,0},
    [0x01]={0x7E,0x81,0xA5,0x81,0xBD,0x99,0x81,0x7E}, /* smiley (unused)  */
    ...
    /* 0x10..0x17 : custom — used by the SDL UI */
    [0x10]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}, /* full block       */
    [0x11]={0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55}, /* dark shade 50%   */
    [0x12]={0x88,0x22,0x88,0x22,0x88,0x22,0x88,0x22}, /* light shade 25%  */
    [0x13]={0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18}, /* vertical bar     */
    [0x14]={0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0x00}, /* horizontal bar   */
    [0x15]={0x00,0x18,0x3C,0x7E,0xFF,0x7E,0x3C,0x18}, /* diamond          */
    [0x16]={0x00,0x18,0x3C,0x7E,0xFF,0xFF,0xFF,0x00}, /* triangle ▶       */
    [0x17]={0x00,0x10,0x18,0x1C,0x1E,0x1C,0x18,0x10}, /* arrow ▶          */
    [0x18]={0x00,0x18,0x3C,0x7E,0x18,0x18,0x18,0x18}, /* up arrow         */
    [0x19]={0x18,0x18,0x18,0x18,0x7E,0x3C,0x18,0x00}, /* down arrow       */
    [0x1A]={0x10,0x18,0x1C,0x1E,0x1C,0x18,0x10,0x00}, /* right arrow      */
    [0x1B]={0x08,0x18,0x38,0x78,0x38,0x18,0x08,0x00}, /* left arrow       */
    [0x1C]={0x18,0x3C,0x7E,0xFF,0xFF,0x7E,0x3C,0x18}, /* solid diamond    */
    [0x1D]={0x00,0x18,0x3C,0x66,0xC3,0x66,0x3C,0x18}, /* outline diamond  */
    [0x1E]={0x18,0x3C,0x7E,0xFF,0xFF,0xFF,0xFF,0xFF}, /* upper triangle   */
    [0x1F]={0xFF,0xFF,0xFF,0xFF,0xFF,0x7E,0x3C,0x18}, /* lower triangle   */

    /* 0x20..0x7F : printable ASCII (dhepper/font8x8 — public domain) */
